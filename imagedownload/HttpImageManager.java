...
public class HttpImageManager{
    ...
    public static class LoadRequest {
        ...
        public LoadRequest(Uri uri, ImageView v,ProgressBar progress){
            this(uri, v, progress,null);
        }


        public LoadRequest(Uri uri, OnLoadResponseListener l){
            this( uri, null, null, l);
        }


        public LoadRequest(Uri uri, ImageView v,ProgressBar progress, OnLoadResponseListener l){
            if(uri == null) 
    ...
    public Bitmap loadImage( LoadRequest r ) {
        ...
        if(mCache != null && mCache.exists(key)) {
        	...
        	r.getProgressBar().setVisibility(View.GONE);
